...
WebUI.mouseOver(findTestObject('changshanghoutai/软件工具设置/品牌页配置/编辑/品牌介绍/企业新闻/进入企业新闻/div_企业新闻'))

WebUI.click(findTestObject('changshanghoutai/软件工具设置/品牌页配置/编辑/品牌介绍/企业新闻/进入企业新闻/span_编辑'))
