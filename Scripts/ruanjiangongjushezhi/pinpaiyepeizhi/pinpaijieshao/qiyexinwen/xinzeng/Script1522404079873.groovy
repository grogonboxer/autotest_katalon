...
WebUI.click(findTestObject('changshanghoutai/软件工具设置/品牌页配置/编辑/品牌介绍/企业新闻/新增/button_新增'))
...
WebUI.setText(findTestObject('changshanghoutai/软件工具设置/品牌页配置/编辑/品牌介绍/企业新闻/新增/input_文章标题'), 'dpjia')
