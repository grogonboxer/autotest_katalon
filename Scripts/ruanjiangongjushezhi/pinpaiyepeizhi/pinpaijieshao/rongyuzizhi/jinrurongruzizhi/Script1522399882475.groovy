...
WebUI.mouseOver(findTestObject('changshanghoutai/软件工具设置/品牌页配置/编辑/品牌介绍/荣誉资质/进入荣誉资质/div_荣誉资质'))

WebUI.click(findTestObject('changshanghoutai/软件工具设置/品牌页配置/编辑/品牌介绍/荣誉资质/进入荣誉资质/span_编辑'))
