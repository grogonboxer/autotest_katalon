...
WebUI.click(findTestObject('changshanghoutai/软件工具设置/品牌页配置/编辑/品牌介绍/荣誉资质/新增/button_新增'))

WebUI.delay(2)

WebUI.setText(findTestObject('changshanghoutai/软件工具设置/品牌页配置/编辑/品牌介绍/荣誉资质/新增/input_标题'), 'ABC看')
