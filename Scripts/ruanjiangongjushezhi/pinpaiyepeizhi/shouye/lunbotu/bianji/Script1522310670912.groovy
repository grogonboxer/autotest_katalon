...
WebUI.waitForElementVisible(findTestObject('changshanghoutai/软件工具设置/品牌页配置/编辑/首页/轮播图/编辑/i_编辑'), 5)

WebUI.click(findTestObject('changshanghoutai/软件工具设置/品牌页配置/编辑/首页/轮播图/编辑/i_编辑'))

WebUI.delay(4)

WebUI.waitForElementVisible(findTestObject('changshanghoutai/软件工具设置/品牌页配置/编辑/首页/轮播图/新增/button_完成'), 0)
