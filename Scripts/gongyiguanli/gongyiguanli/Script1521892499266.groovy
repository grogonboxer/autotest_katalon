...
WebUI.waitForElementVisible(findTestObject('changshanghoutai/左侧菜单/工艺管理/a_五金孔位'), 20)

WebUI.click(findTestObject('changshanghoutai/左侧菜单/工艺管理/a_五金孔位'))

WebUI.waitForElementVisible(findTestObject('changshanghoutai/左侧菜单/工艺管理/a_打孔工艺'), 20)
