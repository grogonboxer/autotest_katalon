...
WebUI.click(findTestObject('changshanghoutai/商品管理/商品列表/设计师自定义商品/新增/a_新增'))
...
WebUI.selectOptionByIndex(findTestObject('changshanghoutai/商品管理/商品列表/设计师自定义商品/新增/select_用途'), 2)

WebUI.delay(2)

WebUI.selectOptionByIndex(findTestObject('changshanghoutai/商品管理/商品列表/设计师自定义商品/新增/select_二级分类'), 16)

WebUI.delay(2)

WebUI.selectOptionByIndex(findTestObject('changshanghoutai/商品管理/商品列表/设计师自定义商品/新增/select_三级分类'), 2)
