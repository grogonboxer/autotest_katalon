...
WebUI.click(findTestObject('changshanghoutai/商品管理/商品列表/自定义商品/新增/a_新增'))
...
WebUI.selectOptionByIndex(findTestObject('changshanghoutai/商品管理/商品列表/自定义商品/新增/select_商品用途'), 1)

WebUI.delay(3)

WebUI.setText(findTestObject('changshanghoutai/商品管理/商品列表/自定义商品/新增/input_商品编码'), 'spbm01')

WebUI.selectOptionByIndex(findTestObject('changshanghoutai/商品管理/商品列表/自定义商品/新增/select_所属品牌'), 3)

WebUI.delay(3)

WebUI.selectOptionByIndex(findTestObject('changshanghoutai/商品管理/商品列表/自定义商品/新增/select_所属系列'), 1)

WebUI.delay(3)

WebUI.selectOptionByIndex(findTestObject('changshanghoutai/商品管理/商品列表/自定义商品/新增/select_商品分类一级'), 8)

WebUI.delay(3)

WebUI.selectOptionByIndex(findTestObject('changshanghoutai/商品管理/商品列表/自定义商品/新增/select_商品分类二级'), 9)
