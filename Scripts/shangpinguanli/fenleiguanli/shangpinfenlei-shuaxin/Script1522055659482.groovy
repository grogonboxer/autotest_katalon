...
WebUI.waitForElementVisible(findTestObject('changshanghoutai/左侧菜单/商品管理/a_分类管理'), 20)

WebUI.click(findTestObject('changshanghoutai/左侧菜单/商品管理/a_分类管理'))

WebUI.waitForElementVisible(findTestObject('changshanghoutai/商品管理/分类管理/button_刷新'), 20)

WebUI.delay(10)

WebUI.click(findTestObject('changshanghoutai/商品管理/分类管理/button_刷新'))
