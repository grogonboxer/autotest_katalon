...
WebUI.setText(findTestObject('changshanghoutai/供货方管理/供货方列表页/input_搜索框'), quancheng)

WebUI.click(findTestObject('changshanghoutai/供货方管理/供货方列表页/button_搜索'))

WebUI.delay(5)

WebUI.verifyTextPresent(quancheng, false)

WebUI.click(findTestObject('changshanghoutai/供货方管理/供货方列表页/button_刷新'))

WebUI.waitForElementVisible(findTestObject('changshanghoutai/供货方管理/供货方列表页/div_刷新成功提示'), 0)

WebUI.setText(findTestObject('changshanghoutai/供货方管理/供货方列表页/input_搜索框'), '')
...
WebUI.click(findTestObject('changshanghoutai/供货方管理/供货方列表页/input_选中一条导出'))

WebUI.click(findTestObject('changshanghoutai/供货方管理/供货方列表页/button_导出'))
