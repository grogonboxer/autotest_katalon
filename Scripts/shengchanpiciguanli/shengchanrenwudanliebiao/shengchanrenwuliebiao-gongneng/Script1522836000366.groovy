...
WebUI.click(findTestObject('changshanghoutai/生产批次管理/生产任务单列表/生产任务单列表页/a_xml下载'))

WebUI.back()

WebUI.click(findTestObject('changshanghoutai/生产批次管理/生产任务单列表/生产任务单列表页/input_选中一条导出'))

WebUI.click(findTestObject('changshanghoutai/生产批次管理/生产任务单列表/生产任务单列表页/button_导出'))
