...
'点击新增按钮'
WebUI.click(findTestObject('changshanghoutai/业务类型/新增/a_新增'), FailureHandling.STOP_ON_FAILURE)
...
'点击取消'
WebUI.click(findTestObject('changshanghoutai/业务类型/新增/button_取消'), FailureHandling.STOP_ON_FAILURE)
