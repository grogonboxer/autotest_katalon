...
'等待分类列表'
WebUI.waitForElementVisible(findTestObject('changshanghoutai/供货商管理/供货商分类/新增编辑/i_编辑'), 10)

'点击编辑按钮'
WebUI.click(findTestObject('changshanghoutai/供货商管理/供货商分类/新增编辑/i_编辑'), FailureHandling.STOP_ON_FAILURE)
