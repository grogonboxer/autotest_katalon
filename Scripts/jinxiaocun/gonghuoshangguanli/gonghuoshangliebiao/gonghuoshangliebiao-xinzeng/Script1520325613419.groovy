...
'等待供货商列表数据'
WebUI.waitForElementVisible(findTestObject('changshanghoutai/供货商管理/供货商列表/新增编辑/a_新增'), 10)

'点击新增按钮'
WebUI.click(findTestObject('changshanghoutai/供货商管理/供货商列表/新增编辑/a_新增'), FailureHandling.STOP_ON_FAILURE)

'等待新增供货商页'
WebUI.waitForElementVisible(findTestObject('changshanghoutai/供货商管理/供货商列表/新增编辑/select_选择内部外部类型'), 10)

'选择供货商类型'
WebUI.selectOptionByValue(findTestObject('changshanghoutai/供货商管理/供货商列表/新增编辑/select_选择内部外部类型'), '内部', true)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.selectOptionByValue(findTestObject('changshanghoutai/供货商管理/供货商列表/新增编辑/select_选择类型'), 'supplier', true)
