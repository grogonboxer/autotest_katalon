...
'等待区域列表'
WebUI.waitForElementVisible(findTestObject('changshanghoutai/供货商管理/区域设置/新增编辑/i_编辑'), 10)

'点击编辑按钮'
WebUI.click(findTestObject('changshanghoutai/供货商管理/区域设置/新增编辑/i_编辑'), FailureHandling.STOP_ON_FAILURE)
...
'选择省'
WebUI.selectOptionByValue(findTestObject('changshanghoutai/供货商管理/区域设置/新增编辑/select_选择省'), '1', true)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

'选择市'
WebUI.selectOptionByValue(findTestObject('changshanghoutai/供货商管理/区域设置/新增编辑/select_选择市'), '1', true)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

'选择区'
WebUI.selectOptionByValue(findTestObject('changshanghoutai/供货商管理/区域设置/新增编辑/select_选择区'), '7', true)
