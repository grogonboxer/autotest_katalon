...
'等待类型列表'
WebUI.waitForElementVisible(findTestObject('changshanghoutai/仓库管理/仓库类型/新增编辑/button_新增'), 10)

'点击新增按钮'
WebUI.click(findTestObject('changshanghoutai/仓库管理/仓库类型/新增编辑/button_新增'), FailureHandling.STOP_ON_FAILURE)
