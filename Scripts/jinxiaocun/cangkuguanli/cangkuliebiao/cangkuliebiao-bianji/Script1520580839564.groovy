...
WebUI.verifyElementText(findTestObject('changshanghoutai/仓库管理/仓库列表/新增编辑/a_验证新增'), xinjiancangkumingcheng)

'点击编辑按钮'
WebUI.click(findTestObject('changshanghoutai/仓库管理/仓库列表/新增编辑/i_编辑'), FailureHandling.STOP_ON_FAILURE)
...
'选择区'
WebUI.selectOptionByValue(findTestObject('changshanghoutai/仓库管理/仓库列表/新增编辑/select_选择区'), '2', true)

'输入详细地址'
WebUI.setText(findTestObject('changshanghoutai/仓库管理/仓库列表/新增编辑/input_详细地址'), xiangxidizhi)

'选择负责人'
WebUI.selectOptionByValue(findTestObject('changshanghoutai/仓库管理/仓库列表/新增编辑/select_负责人'), '268', true)
